...
void digital_9(void)
{
  ...
  digitalWrite(b, HIGH); // superior dir
  digitalWrite(d, HIGH); // TRAÇO INFERIOR
  digitalWrite(c, HIGH); //TRAÇO LATERAL DIR
  digitalWrite(e, LOW); // inf esq
  digitalWrite(f, HIGH); // SUPERIOR ESQ
  digitalWrite(a, HIGH);// topo
  digitalWrite(g,HIGH);
  digitalWrite(pinled, LOW);
}
